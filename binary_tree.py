    ...
    def find(self, value: int):
        ...
        while current_node:
            if value == current_node.value:
                ...
                current_node = current_node.left
        raise LookupError("no such node in the current tree")

    def inorder(self):
        self._inorder_rec(self.head)
